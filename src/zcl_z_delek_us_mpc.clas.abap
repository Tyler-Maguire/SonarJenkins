class ZCL_Z_DELEK_US_MPC definition
  public
...
public section.
  ...
  begin of TS_FILE,
     ...
     DATESTAMP type C length 8,
     MEDIARESOURCE type xstring,
...
CLASS ZCL_Z_DELEK_US_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_DELEK_US_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'FILE' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Datestamp' iv_abap_fieldname = 'DATESTAMP' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 8 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MediaResource' iv_abap_fieldname = 'MEDIARESOURCE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_DELEK_US_MPC=>TS_FILE' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190304073103'.                  "#EC NOTEXT
